...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create palooza-app-ba2b
  fly apps create palooza-app-ba2b-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app palooza-app-ba2b
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app palooza-app-ba2b-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'palooza-app-ba2b-staging' does not match app name in config file 'palooza-app-ba2b'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name palooza-app-ba2b-db
  fly postgres attach --app palooza-app-ba2b palooza-app-ba2b-db

  fly postgres create --name palooza-app-ba2b-staging-db
  fly postgres attach --app palooza-app-ba2b-staging palooza-app-ba2b-staging-db
  ```
